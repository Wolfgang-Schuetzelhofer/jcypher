...
public class RETURN {
	 ...
	 * <div color='red' style="font-size:18px;color:red"><i>e.g. <b>RETURN.resultOf(P.valueOf(a.property("age")).GT(30))</b></i></div>
	 * <br/>
	 */
	 ...
	 * <div color='red' style="font-size:18px;color:red"><i>e.g. <b>RETURN.resultOf(C.COLLECT().property("name").from(nds))<b></i></div>
	 * <br/>
	 */
	 ...
	 * <div color='red' style="font-size:18px;color:red"><i>e.g. <b>RETURN.resultOf(p.nodes())</b></i></div>
	 * <div color='red' style="font-size:18px;color:red"><i>or <b>RETURN.resultOf(n.labels())</b></i></div>
	 * <br/>
	 */
	 ...
	 * <div color='red' style="font-size:18px;color:red"><i>e.g. <b>RETURN.DISTINCT().resultOf(p.nodes())</b></i></div>
	 * <br/>
	 */
