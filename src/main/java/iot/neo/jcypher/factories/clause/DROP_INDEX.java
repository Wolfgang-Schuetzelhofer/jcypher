...
import iot.neo.jcypher.api.index.IFactory;
import iot.neo.jcypher.api.index.IndexFor;
...
public class DROP_INDEX {
	 ...
	 * <div color='red' style="font-size:18px;color:red"><i>e.g. <b>DROP_INDEX.onLabel("Person")</b>...</i></div>
	 * <br/>
	 */
