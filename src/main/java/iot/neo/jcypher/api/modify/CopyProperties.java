...
package iot.neo.jcypher.api.modify;
...
public class CopyProperties<T extends APIObject> extends APIObject {
	 ...
	 * <div color='red' style="font-size:18px;color:red"><i>select a node or relation to be the target for copying all properties</i></div>
