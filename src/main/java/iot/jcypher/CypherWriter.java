...
import iot.jcypher.ast.collection.EvalExpression;
...
import iot.jcypher.ast.nativ.NativeCypherExpression;
import iot.jcypher.ast.pattern.PatternElement;
import iot.jcypher.ast.pattern.PatternExpression;
import iot.jcypher.ast.pattern.PatternNode;
import iot.jcypher.ast.pattern.PatternPath;
import iot.jcypher.ast.pattern.PatternProperty;
import iot.jcypher.ast.pattern.PatternRelation;
import iot.jcypher.ast.pattern.PatternPath.PathFunction;
import iot.jcypher.ast.pattern.PatternRelation.Direction;
...
import iot.jcypher.ast.returns.Order;
...
import iot.jcypher.ast.returns.ReturnValue;
import iot.jcypher.ast.returns.ReturnAggregate.AggregateFunctionType;
import iot.jcypher.ast.start.PropertyOrQuery;
	...
	private static class ReturnCypherWriter {
		...
		private static void toCypherExpression(ReturnExpression rx, WriterContext context) {
			...
			if (rx.getAlias() != null) {
				...
				ValueWriter.toValueExpression(rx.getAlias(), context);
			}
		...
		private static void toCypherExpression(ReturnAggregate ra,
			...
			if (ra.isDistinct())
				context.buffer.append("DISTINCT ");
			ValueWriter.toValueExpression(ra.getArgument(), context);
